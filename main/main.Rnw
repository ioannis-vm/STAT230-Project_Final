...
% plots
Below, we plot the coefficients still remaining as the L1-norm threshold for the coefficients become more restrictive. 
...
plot(lasso.mod, label=5)    # Draw plot of coefficients
...
Presented are the predicted probabilities for the building type of the first 100 buildings. 
